...
$(document).ready(function () {
    ...
    (function () {
        ...
        var url = address + "testProjectController/selectAllByPage";
...
function createTable(dataSet) {
    ...
    dataSet.forEach(function (value) {
        var tr = $('<tr></tr>');
        var tdId = $("<td class=\"td-itemId\"></td>").text(value.id);
        var tdName = $("<td class=\"td-name\"></td>").text(value.testProjectName);
        var tdType = $("<td class=\"td-type\"></td>").text(value.type);
        var tdUser = $("<td class=\"td-user\"></td>").text(value.user);
        var tdCreateDate = $("<td class=\"td-createDate\"></td>").text(value.createDate);
        var tdDescription = $("<td class=\"td-description\"></td>").text(value.taskDescription);
        var tdProjectCode = $("<td class=\"td-projectCode\"></td>").text(value.testProjectCode);
...
function destructe(data) {
    ...
    newData = data.map(function (value) {
        ...
        newValue.testProjectCode = value.testProjectCode;
        newValue.testProjectName = value.testProjectName;
        newValue.type = value.type;
        newValue.createDate = value.createDate;
        newValue.taskDescription = value.taskDescription;
        newValue.user = value.creatorId;
